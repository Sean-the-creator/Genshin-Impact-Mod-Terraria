    ...
    class SmithsApprentice : ModNPC
    {
        ...
        public override string GetChat()
        {
            List<string> dialogue = new List<string>
            {
                ...
                "Due to the fact that I'm and apprentice, my weapons aren't as good as Master's, but if you find them affordable I would gladly sell them to you.",
            ...
            if (armsDealer >= 0)
            {
                dialogue.Add("That arms dealer is never made his weapons, yet he has the audacity to sell them");
            }
